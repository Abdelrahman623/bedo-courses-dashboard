...
const Notes: React.FC = () => {
  ...
  return (
    <div className="h-full flex overflow-hidden">
      ...
      {/* ── LEFT SIDEBAR ─────────────────────────────────────────────────── */}
      <div className="w-64 flex-shrink-0 border-r border-white/6 flex flex-col bg-bg-surface/30">
                ...
                <motion.div
                  ...
                  className={[
                    ...
                    isActive
                      ...
                      : 'border-l-2 border-transparent hover:bg-bg-surface2',
                  ].join(' ')}
                >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {!activeNote ? (
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-shrink-0 px-6 pt-5 pb-3 border-b border-white/6 space-y-2.5">
            ...
            {/* ── Status bar ──────────────────────────────────────────── */}
            <div className="flex-shrink-0 flex items-center justify-between px-6 py-2 border-t border-white/6">
